...
// function Robot(name, height, kindnessLvl){
//   this.name = name;
//   this.height = height;
//   this.kindnessLvl = kindnessLvl;
//   this.receiveKindness = function(num){
//     this.kindnessLvl += num;
//     return this
//   }
// }

// Robot.prototype.recieveKindess = function(num){
//  this.kindnessLvl += num;
//  return this
// }

// let t1000 = new Robot('T1000', '6ft 5in', -1000)
// t1000.receiveKindness(10)
// let c3p0 = new Robot('C3P0', '5ft', 400)
...
// const goose = new Car('Canadian', 'Goose', '2000 BCE')
// goose.honk()
